...
class Cliente:
    ...
    def actualizar_categoria(self):  # Método corregido
    ...
    def agregar_servicio(self, servicio):
        ...
        self.actualizar_categoria()  # Actualizamos la categoría cuando se agrega un servicio

# Clase para manejar servicios
class Servicio:
...
# Clase para manejar interacciones con el cliente
class Interaccion:
...
class SistemaMovistar:
    ...
    def ver_servicios_cliente(self, dni: str):
        if dni in self.clientes:
            ...
            print(f"Categoría del cliente: {cliente.categoria.value}")
        else:
